...
* S-Hub
*
* @author Siasat Hub (www.siasathub.com)
* @version 1.4.2
**/
    ...
    tinySlider: function () {
        ...
        if (e.isVariableDefined($carousel)) {
          ...
          tnsCarousel.forEach(slider => {
              ...
              var sliderItems = slider1.getAttribute('data-items') ? slider1.getAttribute('data-items') : 5; //option: number (items in all device)
